...
export async function createSession(req, res) {
  try {
    ...
    if (!userId || !clerkId) {
      console.log("❌ Missing userId or clerkId", { userId, clerkId });
      return res.status(400).json({ message: "User not found in backend" });
    }
    ...
    console.log("✅ Session + Stream created successfully");
